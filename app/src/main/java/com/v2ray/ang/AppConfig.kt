...
object AppConfig {
    ...
    const val PREF_DOMAIN_FILTER_MODE = "pref_domain_filter_mode"
    const val PREF_DOMAIN_FILTER_LIST = "pref_domain_filter_list"
    ...
    const val TG_CHANNEL_URL = "https://t.me/dicodeping"
